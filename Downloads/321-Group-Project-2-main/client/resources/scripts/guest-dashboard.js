...
class GuestDashboard {
    ...
    renderProgress() {
        ...
        // Simulate progress data (in real app, this would come from API)
        const mockProgress = [
            { subject: 'Math', completed: 12, total: 20, percentage: 60 },
            { subject: 'Reading', completed: 8, total: 15, percentage: 53 },
            { subject: 'Science', completed: 5, total: 12, percentage: 42 },
            { subject: 'Writing', completed: 3, total: 10, percentage: 30 }
        ];
                    ...
                    <div class="content-card">
                        ...
                        <div class="stats-grid">
                            ${mockProgress.map(subject => `
                                <div class="stat-box">
                                    <div class="stat-number">${subject.percentage}%</div>
                            ...
                            ${mockProgress.map(subject => `
                                <div class="mb-3">
                                    <div class="d-flex justify-content-between mb-2">
                                        ...
                                        <span class="text-muted">${subject.completed}/${subject.total} lessons</span>
                                    </div>
